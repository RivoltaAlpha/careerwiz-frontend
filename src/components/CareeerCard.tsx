...
const CareerCard: React.FC<CareerCardProps> = ({ career_id, CareerName, image, interests }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden transition duration-300 ease-in-out transform hover:scale-105">
      <div className="md:flex">
        ...
        <div className="p-8">
          <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold">{CareerName}</div>
